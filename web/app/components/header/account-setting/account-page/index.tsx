  ...
  const renderAppItem = (item: IItem) => {
    return (
      <div className="flex px-3 py-1">
        ...
        <div className="mt-[3px] text-xs font-medium text-gray-700 leading-[18px]">
          {item.name}
        </div>
      </div>
    )
    ...
    <>
      ...
      <div className="mb-8">
        ...
        <div
          className={classNames(
            'flex items-center justify-between mt-2 w-full h-9 px-3 bg-gray-100 rounded text-sm font-normal text-gray-800 cursor-pointer group',
          )}
        >
          {userProfile.name}
          <div
      ...
      {IS_CE_EDITION && (
        <div className="mb-8">
          ...
          <Button
            className="font-medium !text-gray-700 !px-3 !py-[7px] !text-[13px]"
            onClick={() => setEditPasswordModalVisible(true)}
          >
      ...
      {showDeleteAccountModal && (
        ...
        >
          ...
          <div className="pt-6 flex justify-end items-center">
            <Button
              className="w-24 text-gray-700 text-sm font-medium"
              onClick={() => setShowDeleteAccountModal(false)}
            >
